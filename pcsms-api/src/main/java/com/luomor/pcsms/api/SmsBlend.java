package com.luomor.pcsms.api;

import com.luomor.pcsms.api.callback.CallBack;
...
public interface SmsBlend {
    ...
    /**
     * <p>说明：从黑名单移除【为了pcsms组件有统一入口，同时这个需要有全局操作的同时需要操作缓存，那么不给smsblend实际处理，代理部分处理】
     * removeFromBlacklist
     *
     * @param phone 需要加入黑名单的手机号
     * @author Peter
    ...
    /**
     * <p>说明：批量加入黑名单【为了pcsms组件有统一入口，同时这个需要有全局操作的同时需要操作缓存，那么不给smsblend实际处理，代理部分处理】
     * batchJoinBlacklist
     *
    ...
    /**
     * <p>说明：批量从黑名单移除【为了pcsms组件有统一入口，同时这个需要有全局操作的同时需要操作缓存，那么不给smsblend实际处理，代理部分处理】
